/* The template below makes use of Vuetify components CARD,IMAGE,BUTTOM and ICON
to style the news application layout*/
<template>
  <v-layout row wrap align-center>
      <v-flex xs8 offset-md2>
        <div v-for="article in articles" :key="article.title">
          ...
          <v-btn icon class="red--text"</v-btn>
            <v-icon small>fa-google-plus</v-icon>
          </v-btn>
          <v-btn icon class="blue--text text--darken-3">
